						...
						<div class="content">
							...
							<form class="form-auth-small" action="{{ route('postregister') }}" method="post">
                                ...
                                <div class="form-group">
									<label for="signin-email" class="control-label sr-only">Nama Anda</label>
									<input type="text" class="form-control" id="signin-email" name="name" placeholder="Nama Anda">
								</div>
								<div class="form-group">
								...
								<div class="bottom">
									<span class="helper-text"><i class="fa fa-lock"></i> <a href="/login">Already have any account ?</a></span><br>
								</div>
							</form>
						</div>
					</div>
